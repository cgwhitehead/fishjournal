...
import Material.Helpers exposing (map1st, map2nd, partsUpdatePort)
...
-}
type alias Model =
    { button : Indexed (List Int) Button.Model
    , textfield : Indexed (List Int) Textfield.Model
    , menu : Indexed (List Int) Menu.Model
    , snackbar : Maybe (Snackbar.Model Int)
    , layout : Layout.Model
    , toggles : Indexed (List Int) Toggles.Model
    , tooltip : Indexed (List Int) Tooltip.Model
    , tabs :
        Indexed (List Int) Tabs.Model
